...
PLANET_DATA = [
    ...
    ("Mercury", 0.15,   "assets/texture/planets/mer_nasa.png",       2.0,       4.15,        0.3),
    ("Venus",   0.18,   "assets/texture/planets/ven_nasa.jpg",       3.0,       1.62,        0.2),
    ("Earth",   0.20,   "assets/texture/planets/earth_nasa.png",     4.0,       1.0,         0.5),
    ("Mars",    0.17,   "assets/texture/planets/mars_nasa.jpg",      5.5,       0.53,        0.4),
    ...
    ("Neptune", 0.27,   "assets/texture/planets/nep_nasa.jpg",       13.0,      0.006,       0.9),
